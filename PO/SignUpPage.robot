...
Verify the confirmation message and user is logged in
	...
	${welcomeNote}=                     Get Text            css:.title
	log     ${welcomeNote}
...
Verify error message when username already exists
    Wait Until Element Is Visible    customer.username.errors
    ${username_exist_message}=  Get Text     customer.username.errors
...
Verify Error Message when passwords don't match
    Wait Until Element Is Visible    repeatedPassword.errors
    ${password_mismatch}=   Get Text    repeatedPassword.errors
...
Verify Error Messages displayed when signup form is empty
	Wait Until Element Is Visible    customer.firstName.errors
